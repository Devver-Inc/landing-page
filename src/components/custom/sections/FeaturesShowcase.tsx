  ...
  return (
    <section id="features" className="relative py-32 bg-neutral-950 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <motion.div
          className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-emerald-600/10 rounded-full"
      ...
      <div className="relative max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-20">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 mb-6 rounded-full bg-emerald-500/10 backdrop-blur-sm border border-emerald-500/20"
          >
            <span className="relative flex h-2 w-2">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
              <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-500"></span>
            </span>
            <span className="text-sm font-semibold text-emerald-300">Powerful Features</span>
          </motion.div>
          ...
          >
            ...
            <br />
            <span className="bg-gradient-to-r from-emerald-400 via-green-400 to-emerald-400 bg-clip-text text-transparent">Ship with Confidence</span>
          </motion.h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            ...
            >
              ...
              {/* Card content */}
              <div className="relative h-full bg-neutral-900/90 backdrop-blur-xl rounded-2xl border border-neutral-800 p-8 hover:border-neutral-700 transition-all duration-300">
                {/* Icon */}
                <div className="mb-6">
                  <div
                ...
                {/* Content */}
                <h3 className="text-2xl font-bold text-white mb-3 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:bg-clip-text group-hover:from-white group-hover:to-neutral-300 transition-all">
                  {feature.title}
                </h3>
                <p className="text-neutral-400 leading-relaxed mb-6">{feature.description}</p>
                ...
                <div className="pt-6 border-t border-neutral-800">
                  <div className="flex items-end justify-between">
                    <div>
                      ...
                      <div className="text-sm text-neutral-500 mt-1">{feature.detail}</div>
                    </div>
                    <motion.div
        ...
        >
          <a href="#pricing" className="inline-flex items-center gap-2 text-emerald-400 hover:text-emerald-300 font-semibold transition-colors group">
            See all features
